                ...
                {stageCandidates.length === 0 ? (
                  ...
                  stageCandidates.map((candidate) => (
                    <article
                      ...
                      className="rounded-xl border border-[#ECE8E2] bg-white p-3.5 hover:translate-y-[-3px] transition-all duration-200 shadow-sm hover:shadow-md hover:border-brand-purple/35 flex flex-col justify-between min-h-[175px] cursor-pointer"
                    >
                      <div>
